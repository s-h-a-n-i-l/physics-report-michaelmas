...
\end{itemize}
$\\$
Transformer iron and copper above 40 were both taken twice as the initial readings did not seem to fit with the literature and were assumed to have an error in measurement. These were retaken at the end of the experiment and found to be indistinguishable and thus the initial readings were used for the data analysis.
$\\$
$\\$
...
$\\$
$\\$
Interpreting the results from Figure~\ref{fig:air-control-raw}, the relative permeability \(\mu_{\mathrm{r}}\) was 
calculated from the numeric gradient \(dB/dH\).
\begin{gather}
  \mu_{\mathrm{r}} = \frac{1}{\mu_0}\frac{dB}{dH} \\
  y = (4.667\times 10^{-07} \pm 1.260\times 10^{-10})x + (3.816\times 10^{-04} \pm 2.511\times 10^{-06}) \label{eq:air-fit-line} \\
  \intertext{Therefore:}
