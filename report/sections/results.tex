...
\begin{table}[htbp]
  \centering
  \caption{Linear regression summary for CuNi above \SI{40}{\celsius} (cell 13).}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lccccc}
    \toprule
    Sample & \(B\) range (\si{\tesla}) & \(H\) range (\si{\ampere\metre^{-1}}) & Max \(\mu_{\mathrm{r}}\) & Min \(\mu_{\mathrm{r}}\) & Power loss per unit volume (\si{\watt\per\metre\cubed}) \\
    \midrule
